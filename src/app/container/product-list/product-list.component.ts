...
ngOnInit(): void {
  this.totalStock=this.product.length
  this.total_in_stock=this.product.filter(p => p.is_in_inventory).length
  this.total_out_of_stock=this.product.filter(p=>!p.is_in_inventory).length
}

onFilterChange(value:string){
  this.selectedRadioButton=value
//console.log('Parent - ' + this.selectedRadioButton)
}
